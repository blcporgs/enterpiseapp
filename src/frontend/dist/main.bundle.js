...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory(__webpack_require__(7294), __webpack_require__(3727), __webpack_require__(5697), __webpack_require__(71));
	else {}
...
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-styles/css/utilities/Spacing/spacing.css
// extracted by mini-css-extract-plugin
...
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-core/node_modules/tslib/tslib.es6.js
/*! *****************************************************************************
...
var page = __webpack_require__(6518);
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-styles/dist/esm/index.js
...
function createIcon({ name, xOffset = 0, yOffset = 0, width, height, svgPath }) {
    ...
    return _a = class SVGIcon extends react.Component {
            ...
            render() {
                const _a = this.props, { size, color, title, noVerticalAlign } = _a, props = tslib_es6_rest(_a, ["size", "color", "title", "noVerticalAlign"]);
...
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-icons/dist/esm/icons/bars-icon.js
...
const Spinner = (_a) => {
    ...
    return (react.createElement(Component, Object.assign({ className: css(spinner/* default.spinner */.Z.spinner, spinner/* default.modifiers */.Z.modifiers[size], className), role: "progressbar", "aria-valuetext": ariaValueText }, (isSVG && { viewBox: '0 0 100 100' }), (diameter && { style: { '--pf-c-spinner--diameter': diameter } }), props), isSVG ? (react.createElement("circle", { className: spinner/* default.spinnerPath */.Z.spinnerPath, cx: "50", cy: "50", r: "45", fill: "none" })) : (react.createElement(react.Fragment, null,
        react.createElement("span", { className: css(spinner/* default.spinnerClipper */.Z.spinnerClipper) }),
        react.createElement("span", { className: css(spinner/* default.spinnerLeadBall */.Z.spinnerLeadBall) }),
        react.createElement("span", { className: css(spinner/* default.spinnerTailBall */.Z.spinnerTailBall) })))));
};
Spinner.displayName = 'Spinner';
//# sourceMappingURL=Spinner.js.map
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-core/dist/esm/helpers/OUIA/ouia.js
...
const useOUIAId = (componentType, id, variant) => {
    ...
    return (0,react.useMemo)(() => getDefaultOUIAId(componentType, variant), [componentType, variant]);
};
/**
...
var drawer = __webpack_require__(3357);
...
const DrawerPanelContent = (_a) => {
    ...
    const handleMousedown = (e) => {
        ...
        drawerRef.current.classList.add(css(drawer/* default.modifiers.resizing */.Z.modifiers.resizing));
        isResizing = true;
        setInitialVals = true;
    };
    ...
    const handleMouseup = () => {
        ...
        drawerRef.current.classList.remove(css(drawer/* default.modifiers.resizing */.Z.modifiers.resizing));
        isResizing = false;
    ...
    return (react.createElement("div", Object.assign({ id: id, className: css(drawer/* default.drawerPanel */.Z.drawerPanel, isResizable && drawer/* default.modifiers.resizable */.Z.modifiers.resizable, hasNoBorder && drawer/* default.modifiers.noBorder */.Z.modifiers.noBorder, formatBreakpointMods(widths, drawer/* default */.Z), colorVariant === DrawerColorVariant.light200 && drawer/* default.modifiers.light_200 */.Z.modifiers.light_200, className), ref: panel, onTransitionEnd: ev => {
        ...
        isResizable && (react.createElement(react.Fragment, null,
            react.createElement("div", { className: css(drawer/* default.drawerSplitter */.Z.drawerSplitter, position !== 'bottom' && drawer/* default.modifiers.vertical */.Z.modifiers.vertical), role: "separator", tabIndex: 0, "aria-orientation": position === 'bottom' ? 'horizontal' : 'vertical', "aria-label": resizeAriaLabel, "aria-describedby": resizeAriaDescribedBy, onMouseDown: handleMousedown, onKeyDown: handleKeys, onTouchStart: handleTouchStart },
                react.createElement("div", { className: css(drawer/* default.drawerSplitterHandle */.Z.drawerSplitterHandle), "aria-hidden": true })),
            react.createElement("div", { className: css(drawer/* default.drawerPanelMain */.Z.drawerPanelMain) }, children))),
...
const DrawerMain = (_a) => {
    ...
    return (react.createElement("div", Object.assign({ className: css(drawer/* default.drawerMain */.Z.drawerMain, className) }, props), children));
};
...
const DrawerContent = (_a) => {
    ...
    return (react.createElement(DrawerMain, null,
        react.createElement("div", Object.assign({ className: css(drawer/* default.drawerContent */.Z.drawerContent, colorVariant === DrawerColorVariant.light200 && drawer/* default.modifiers.light_200 */.Z.modifiers.light_200, className) }, props), children),
        panelContent));
};
...
const DrawerContentBody = (_a) => {
    ...
    return (react.createElement("div", Object.assign({ className: css(drawer/* default.drawerBody */.Z.drawerBody, hasPadding && drawer/* default.modifiers.padding */.Z.modifiers.padding, className) }, props), children));
};
...
const PageGroup = (_a) => {
    ...
    return (react.createElement("div", Object.assign({}, props, { className: css(page/* default.pageMainGroup */.Z.pageMainGroup, sticky === 'top' && page/* default.modifiers.stickyTop */.Z.modifiers.stickyTop, sticky === 'bottom' && page/* default.modifiers.stickyBottom */.Z.modifiers.stickyBottom, hasShadowTop && page/* default.modifiers.shadowTop */.Z.modifiers.shadowTop, hasShadowBottom && page/* default.modifiers.shadowBottom */.Z.modifiers.shadowBottom, hasOverflowScroll && page/* default.modifiers.overflowScroll */.Z.modifiers.overflowScroll, className) }), children));
};
...
class Page extends react.Component {
    ...
    render() {
        ...
        if (tertiaryNav && isTertiaryNavWidthLimited) {
            nav = (react.createElement("div", { className: css(page/* default.pageMainNav */.Z.pageMainNav, page/* default.modifiers.limitWidth */.Z.modifiers.limitWidth) },
                react.createElement("div", { className: css(page/* default.pageMainBody */.Z.pageMainBody) }, tertiaryNav)));
        }
        else if (tertiaryNav) {
            nav = react.createElement("div", { className: css(page/* default.pageMainNav */.Z.pageMainNav) }, tertiaryNav);
        }
        let crumb = null;
        if (breadcrumb && isBreadcrumbWidthLimited) {
            crumb = (react.createElement("section", { className: css(page/* default.pageMainBreadcrumb */.Z.pageMainBreadcrumb, page/* default.modifiers.limitWidth */.Z.modifiers.limitWidth) },
                react.createElement("div", { className: css(page/* default.pageMainBody */.Z.pageMainBody) }, breadcrumb)));
        }
        else if (breadcrumb) {
            crumb = react.createElement("section", { className: css(page/* default.pageMainBreadcrumb */.Z.pageMainBreadcrumb) }, breadcrumb);
        }
        ...
        const main = (react.createElement("main", { ref: this.mainRef, role: role, id: mainContainerId, className: css(page/* default.pageMain */.Z.pageMain), tabIndex: mainTabIndex, "aria-label": mainAriaLabel },
            group,
            !isTertiaryNavGrouped && nav,
            !isBreadcrumbGrouped && crumb,
            children));
        ...
        return (react.createElement(PageContextProvider, { value: context },
            react.createElement("div", Object.assign({}, rest, { className: css(page/* default.page */.Z.page, className) }),
                skipToContent,
                header,
                sidebar,
                notificationDrawer && (react.createElement("div", { className: css(page/* default.pageDrawer */.Z.pageDrawer) },
...
const PageHeader = (_a) => {
    ...
    return (react.createElement(PageContextConsumer, null, ({ isManagedSidebar, onNavToggle: managedOnNavToggle, isNavOpen: managedIsNavOpen }) => {
        ...
        return (react.createElement("header", Object.assign({ role: role, className: css(page/* default.pageHeader */.Z.pageHeader, className) }, props),
            (showNavToggle || logo) && (react.createElement("div", { className: css(page/* default.pageHeaderBrand */.Z.pageHeaderBrand) },
                showNavToggle && (react.createElement("div", { className: css(page/* default.pageHeaderBrandToggle */.Z.pageHeaderBrandToggle) },
                    react.createElement(Button, { id: "nav-toggle", onClick: navToggle, "aria-label": ariaLabel, "aria-controls": ariaControls, "aria-expanded": navOpen ? 'true' : 'false', variant: ButtonVariant.plain },
                        react.createElement(bars_icon, null)))),
                logo && (react.createElement(LogoComponent, Object.assign({ className: css(page/* default.pageHeaderBrandLink */.Z.pageHeaderBrandLink) }, logoProps), logo)))),
            topNav && react.createElement("div", { className: css(page/* default.pageHeaderNav */.Z.pageHeaderNav) }, topNav),
            headerTools));
    }));
};
...
var nav = __webpack_require__(8381);
...
class Nav extends react.Component {
    ...
    render() {
        ...
        return (react.createElement(NavContext.Provider, { value: {
            ...
            react.createElement("nav", Object.assign({ className: css(nav/* default.nav */.Z.nav, theme === 'light' && nav/* default.modifiers.light */.Z.modifiers.light, isHorizontal && nav/* default.modifiers.horizontal */.Z.modifiers.horizontal, variant === 'tertiary' && nav/* default.modifiers.tertiary */.Z.modifiers.tertiary, this.state.isScrollable && nav/* default.modifiers.scrollable */.Z.modifiers.scrollable, className), "aria-label": ariaLabel || (variant === 'tertiary' ? 'Local' : 'Global') }, getOUIAProps(Nav.displayName, ouiaId !== undefined ? ouiaId : this.state.ouiaStateId, ouiaSafe), props), children)));
    }
}
Nav.displayName = 'Nav';
Nav.defaultProps = {
...
const NavItem = (_a) => {
    ...
    const renderDefaultLink = (context) => {
        ...
        return (react.createElement(Component, Object.assign({ href: to, onClick: (e) => context.onSelect(e, groupId, itemId, to, preventLinkDefault, onClick), className: css(nav/* default.navLink */.Z.navLink, isActive && nav/* default.modifiers.current */.Z.modifiers.current, className), "aria-current": isActive ? 'page' : null, tabIndex: isNavOpen ? null : '-1' }, props), children));
    };
    const renderClonedChild = (context, child) => react.cloneElement(child, Object.assign(Object.assign({ onClick: (e) => context.onSelect(e, groupId, itemId, to, preventDefault, onClick), 'aria-current': isActive ? 'page' : null }, (styleChildren && {
        className: css(nav/* default.navLink */.Z.navLink, isActive && nav/* default.modifiers.current */.Z.modifiers.current, child.props && child.props.className)
    })), { tabIndex: child.props.tabIndex || isNavOpen ? null : -1 }));
    const ouiaProps = useOUIAProps(NavItem.displayName, ouiaId, ouiaSafe);
    return (react.createElement("li", Object.assign({ className: css(nav/* default.navItem */.Z.navItem, className) }, ouiaProps),
...
var accessibility = __webpack_require__(3339);
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-icons/dist/esm/icons/angle-right-icon.js
...
class NavExpandable extends react.Component {
    ...
    render() {
        ...
        return (react.createElement(NavContext.Consumer, null, context => (react.createElement("li", Object.assign({ className: css(nav/* default.navItem */.Z.navItem, nav/* default.modifiers.expandable */.Z.modifiers.expandable, expandedState && nav/* default.modifiers.expanded */.Z.modifiers.expanded, isActive && nav/* default.modifiers.current */.Z.modifiers.current, className) }, getOUIAProps(NavExpandable.displayName, ouiaId !== undefined ? ouiaId : ouiaStateId), props),
            react.createElement(PageSidebarContext.Consumer, null, ({ isNavOpen }) => (react.createElement("button", Object.assign({ className: nav/* default.navLink */.Z.navLink, id: srText ? null : this.id, onClick: e => this.onExpand(e, context.onToggle), "aria-expanded": expandedState, tabIndex: isNavOpen ? null : -1 }, buttonProps),
                title,
                react.createElement("span", { className: css(nav/* default.navToggle */.Z.navToggle) },
                    react.createElement("span", { className: css(nav/* default.navToggleIcon */.Z.navToggleIcon) },
                        react.createElement(angle_right_icon, { "aria-hidden": "true" })))))),
            react.createElement("section", { className: css(nav/* default.navSubnav */.Z.navSubnav), "aria-labelledby": this.id, hidden: expandedState ? null : true },
                srText && (react.createElement("h2", { className: css(accessibility/* default.screenReader */.Z.screenReader), id: this.id }, srText)),
                react.createElement("ul", { className: css(nav/* default.navList */.Z.navList) }, children))))));
    }
}
...
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-icons/dist/esm/icons/angle-left-icon.js
...
class NavList extends react.Component {
    ...
    render() {
        ...
        return (react.createElement(NavContext.Consumer, null, ({ isHorizontal }) => (react.createElement(PageSidebarContext.Consumer, null, ({ isNavOpen }) => (react.createElement(react.Fragment, null,
            isHorizontal && (react.createElement("button", { className: css(nav/* default.navScrollButton */.Z.navScrollButton), "aria-label": ariaLeftScroll, onClick: this.scrollLeft, disabled: scrollViewAtStart, tabIndex: isNavOpen ? null : -1 },
                react.createElement(angle_left_icon, null))),
            react.createElement("ul", Object.assign({ ref: this.navList, className: css(nav/* default.navList */.Z.navList, className), onScroll: this.handleScrollButtons }, props), children),
            isHorizontal && (react.createElement("button", { className: css(nav/* default.navScrollButton */.Z.navScrollButton), "aria-label": ariaRightScroll, onClick: this.scrollRight, disabled: scrollViewAtEnd, tabIndex: isNavOpen ? null : -1 },
...
var skip_to_content = __webpack_require__(2500);
...
class SkipToContent extends react.Component {
    ...
    render() {
        ...
        return (react.createElement("a", Object.assign({}, rest, { className: css(Button_button/* default.button */.Z.button, Button_button/* default.modifiers.primary */.Z.modifiers.primary, skip_to_content/* default.skipToContent */.Z.skipToContent, className), ref: this.componentRef, href: href }), children));
    }
}
...
;// CONCATENATED MODULE: ./src/app/utils/utils.ts
...
const PageSection = (_a) => {
    ...
    return (react.createElement("section", Object.assign({}, props, { className: css(variantType[type], formatBreakpointMods(padding, page/* default */.Z), variantStyle[variant], isFilled === false && page/* default.modifiers.noFill */.Z.modifiers.noFill, isFilled === true && page/* default.modifiers.fill */.Z.modifiers.fill, isWidthLimited && page/* default.modifiers.limitWidth */.Z.modifiers.limitWidth, sticky === 'top' && page/* default.modifiers.stickyTop */.Z.modifiers.stickyTop, sticky === 'bottom' && page/* default.modifiers.stickyBottom */.Z.modifiers.stickyBottom, hasShadowTop && page/* default.modifiers.shadowTop */.Z.modifiers.shadowTop, hasShadowBottom && page/* default.modifiers.shadowBottom */.Z.modifiers.shadowBottom, hasOverflowScroll && page/* default.modifiers.overflowScroll */.Z.modifiers.overflowScroll, className) }),
        isWidthLimited && react.createElement("div", { className: css(page/* default.pageMainBody */.Z.pageMainBody) }, children),
...
const TextContent = (_a) => {
    ...
    return (react.createElement("div", Object.assign({}, props, { className: css(content/* default.content */.Z.content, className) }), children));
};
...
var title = __webpack_require__(3755);
...
const Title = (_a) => {
    ...
    return (react.createElement(HeadingLevel, Object.assign({}, props, { className: css(title/* default.title */.Z.title, size && title/* default.modifiers */.Z.modifiers[size], className) }), children));
};
Title.displayName = 'Title';
//# sourceMappingURL=Title.js.map
// EXTERNAL MODULE: ./node_modules/@patternfly/react-styles/css/components/DataList/data-list.js
var data_list = __webpack_require__(9778);
// EXTERNAL MODULE: ./node_modules/@patternfly/react-styles/css/components/DataList/data-list-grid.js
var data_list_grid = __webpack_require__(5314);
...
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-icons/dist/esm/icons/grip-vertical-icon.js
...
const DataListDragButton = (_a) => {
    ...
    return (react.createElement(DataListContext.Consumer, null, ({ dragKeyHandler }) => (react.createElement("button", Object.assign({ className: css(data_list/* default.dataListItemDraggableButton */.Z.dataListItemDraggableButton, isDisabled && data_list/* default.modifiers.disabled */.Z.modifiers.disabled, className), onKeyDown: dragKeyHandler, type: "button", disabled: isDisabled }, props),
        react.createElement("span", { className: css(data_list/* default.dataListItemDraggableIcon */.Z.dataListItemDraggableIcon) },
...
const DataListItemRow = (_a) => {
    ...
    return (react.createElement("div", Object.assign({ className: css(data_list/* default.dataListItemRow */.Z.dataListItemRow, className, wrapModifier && data_list/* default.modifiers */.Z.modifiers[wrapModifier]) }, props), react.Children.map(children, child => react.isValidElement(child) &&
        react.cloneElement(child, {
            rowid
        }))));
};
...
const DataListItemCells = (_a) => {
    ...
    return (react.createElement("div", Object.assign({ className: css(data_list/* default.dataListItemContent */.Z.dataListItemContent, className) }, props), dataListCells));
};
...
const DataListAction = (_a) => {
    ...
    return (react.createElement("div", Object.assign({ className: css(data_list/* default.dataListItemAction */.Z.dataListItemAction, formatBreakpointMods(visibility, data_list/* default */.Z), className) }, props), isPlainButtonAction ? react.createElement("div", { className: css(data_list/* default.dataListAction */.Z.dataListAction) }, children) : children));
};
DataListAction.displayName = 'DataListAction';
//# sourceMappingURL=DataListAction.js.map
;// CONCATENATED MODULE: ./node_modules/@patternfly/react-icons/dist/esm/icons/info-alt-icon.js


const InfoAltIconConfig = {
  name: 'InfoAltIcon',
  height: 1024,
  width: 1024,
...
const InfoAltIcon = createIcon(InfoAltIconConfig);

/* harmony default export */ const info_alt_icon = ((/* unused pure expression or super */ null && (InfoAltIcon)));
;// CONCATENATED MODULE: ./src/app/Customers/Customers.tsx




var Customers = function () {
    var _a = react.useState([]), hasData = _a[0], setHasData = _a[1];
    var _b = react.useState(0), curPage = _b[0], setCurPage = _b[1];
    var history = (0,react_router/* useHistory */.k6)();
    // https://gateway.fedev.nip.io:32013/customers?page=0&size=3&sort=name
    var getCustomers = function () { return fetch("/customers-api/customers?page=" + curPage, {
    // method: 'GET', // or 'PUT'
    // headers: {
    ...
    return (react.createElement(PageSection, null,
        react.createElement(TextContent, null,
            react.createElement(Title, { headingLevel: "h1", className: "pf-u-mb-sm" },
                "Customer resource list (Page ",
                curPage + 1,
                " of ",
                hasData.totalPages,
                ")")),
        hasData.content && hasData.content !== [] && react.createElement(DataList, { "aria-label": "Simple data list example" }, hasData.content.map(function (data, idx) {
            return (react.createElement(DataListItem, { key: idx, "aria-labelledby": "item-name-" + idx },
                react.createElement(DataListItemRow, null,
                    react.createElement(DataListItemCells, { dataListCells: [
                            react.createElement(DataListCell, { key: "item-name-" + data.id },
                                react.createElement("span", { id: "item-name-" + data.id },
                                    data.name,
                                    " ",
                                    data.surname)),
                            react.createElement(DataListCell, { key: "item-id-" + data.id }, data.id),
                            react.createElement(DataListCell, { key: "item-address-" + data.id }, data.address),
                            react.createElement(DataListCell, { key: "item-city-" + data.id }, data.city),
                            react.createElement(DataListCell, { key: "item-country-" + data.id }, data.country),
                        ] }),
                    react.createElement(DataListAction, { "aria-labelledby": "single-action-item1 single-action-action1", id: "single-action-action1", "aria-label": "Actions" },
                        react.createElement(Button, { onClick: function () {
                                history.push("/customers/detail/" + data.id);
                            }, variant: "link", icon: react.createElement(InfoAltIcon, null) }, "See details")))));
        }))));
};


// EXTERNAL MODULE: ./node_modules/@patternfly/react-styles/css/layouts/Grid/grid.js
var grid = __webpack_require__(7067);
...
const Grid = (_a) => {
    ...
    return (react.createElement("div", Object.assign({ className: css(...classes, hasGutter && grid/* default.modifiers.gutter */.Z.modifiers.gutter, className), style: style || order ? Object.assign(Object.assign({}, style), setBreakpointCssVars(order, l_grid_item_Order.name)) : undefined }, props), children));
};
...
const GridItem = (_a) => {
    ...
    return (react.createElement("div", Object.assign({ className: css(...classes, className), style: style || order ? Object.assign(Object.assign({}, style), setBreakpointCssVars(order, l_grid_item_Order.name)) : undefined }, props), children));
};
GridItem.displayName = 'GridItem';
//# sourceMappingURL=GridItem.js.map
// EXTERNAL MODULE: ./node_modules/@patternfly/react-styles/css/components/Card/card.js
var card = __webpack_require__(2802);
...
const CardTitle = (_a) => {
    ...
    const Component = component;
    return (react.createElement(Component, Object.assign({ className: css(card/* default.cardTitle */.Z.cardTitle, className) }, props), children));
};
...
const CardBody = (_a) => {
    ...
    const Component = component;
    return (react.createElement(Component, Object.assign({ className: css(card/* default.cardBody */.Z.cardBody, !isFilled && card/* default.modifiers.noFill */.Z.modifiers.noFill, className) }, props), children));
};
...
var description_list = __webpack_require__(6975);
...
const DescriptionListGroup = ({ className, children }) => react.createElement("div", { className: css(description_list/* default.descriptionListGroup */.Z.descriptionListGroup, className) }, children);
...
const DescriptionListTerm = (_a) => {
    ...
    return (react.createElement("dt", Object.assign({ className: css(description_list/* default.descriptionListTerm */.Z.descriptionListTerm, className) }, props),
        react.createElement("span", { className: css(description_list/* default.descriptionListText */.Z.descriptionListText) }, children)));
};
...
const DescriptionListDescription = (_a) => {
    var { children = null, className } = _a, props = __rest(_a, ["children", "className"]);
    return (react.createElement("dd", Object.assign({ className: css(description_list/* default.descriptionListDescription */.Z.descriptionListDescription, className) }, props),
...
;// CONCATENATED MODULE: ./src/app/Customers/CustomerDetail.tsx


var CustomerDetail = function (props) {
    var _a = react.useState(), userData = _a[0], setUserData = _a[1];
    var getCustomerData = function () { return fetch("/customers-api/customers/" + props.computedMatch.params.id); };
    react.useEffect(function () {
        getCustomerData()
            .then(function (response) { return response.json(); })
            .then(function (data) {
    ...
    return (react.createElement(PageSection, null,
        react.createElement(Title, { className: "pf-u-mb-sm", headingLevel: "h1" }, "Details for customer resource"),
        userData && (react.createElement(Grid, null,
            react.createElement(GridItem, { rowSpan: 6, smRowSpan: 12 },
                react.createElement(Card, { isFlat: true },
                    react.createElement(Grid, { className: "pf-m-all-6-col-on-md" },
                            ...
                            react.createElement(CardBody, null,
                                react.createElement(DescriptionList, null,
                                    react.createElement(DescriptionListGroup, null,
                                        react.createElement(DescriptionListTerm, null, "City"),
                                        react.createElement(DescriptionListDescription, null, userData.city)),
                                    react.createElement(DescriptionListGroup, null,
                                        react.createElement(DescriptionListTerm, null, "Country"),
                                        react.createElement(DescriptionListDescription, null, userData.country)),
                                    react.createElement(DescriptionListGroup, null,
                                        react.createElement(DescriptionListTerm, null, "Zipcode"),
                                        react.createElement(DescriptionListDescription, null, userData.zipcode)),
                                    react.createElement(DescriptionListGroup, null,
                                        react.createElement(DescriptionListTerm, null, "User name"),
                                        react.createElement(DescriptionListDescription, null, userData.username))))))))))));
};


;// CONCATENATED MODULE: ./src/app/Orders/Orders.tsx
...
var Orders = function () {
    ...
    var _b = react.useState(0), curPage = _b[0], setCurPage = _b[1];
    var history = (0,react_router/* useHistory */.k6)();
    var getOrders = function () { return fetch("/orders-api/orders?page=" + curPage); };
    react.useEffect(function () {
        getOrders()
            ...
            .then(function (data) { return setHasData(data); })
            .catch(function (error) {
            console.log('Error', error);
        });
    }, [curPage]);
    return (react.createElement(PageSection, null,
        hasData && (react.createElement(TextContent, null,
            react.createElement(Title, { headingLevel: "h1", className: "pf-u-mb-sm" },
                "Orders resource list (Page ",
                curPage + 1,
                " of ",
                hasData.totalPages,
                ")"))),
        hasData && react.createElement(DataList, { "aria-label": "Simple data list example" }, hasData.content.map(function (data, idx) {
            return (react.createElement(DataListItem, { key: idx, "aria-labelledby": "item-name-" + idx },
                react.createElement(DataListItemRow, null,
                    react.createElement(DataListItemCells, { dataListCells: [
                            react.createElement(DataListCell, { key: "item-name-" + data.id },
                            ...
                            react.createElement(DataListCell, { key: "item-id-" + data.id }, data.id),
                            react.createElement(DataListCell, { key: "item-date-" + data.id }, data.date),
                            react.createElement(DataListCell, { key: "item-address-" + data.id }, data.customer.address),
                            react.createElement(DataListCell, { key: "item-city-" + data.id }, data.customer.city),
                            react.createElement(DataListCell, { key: "item-country-" + data.id }, data.customer.country),
                        ] }),
                    react.createElement(DataListAction, { "aria-labelledby": "single-action-item1 single-action-action1", id: "single-action-action1", "aria-label": "Actions" },
                        react.createElement(Button, { onClick: function () {
...
;// CONCATENATED MODULE: ./src/app/Orders/OrderDetail.tsx


var OrderDetail = function (props) {
    var _a = react.useState(), orderData = _a[0], setOrderData = _a[1];
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    var getOrderData = function () { return fetch("/orders-api/orders/" + props.computedMatch.params.id); };
    react.useEffect(function () {
        getOrderData().then(function (result) { return result.json(); }).then(function (data) {
            setOrderData(data);
        });
    }, []);
    return (react.createElement(PageSection, null, orderData && (react.createElement(react.Fragment, null,
        react.createElement(Grid, { hasGutter: true },
            react.createElement(GridItem, { span: 2, smRowSpan: 12 },
                react.createElement(Title, { className: "pf-u-mb-sm", headingLevel: "h1" }, "Customer details"),
                react.createElement(Card, { isFlat: true },
                    react.createElement(Grid, null,
                        react.createElement(GridItem, null,
                            react.createElement(CardBody, null,
                                react.createElement(DescriptionList, null,
                                    react.createElement(DescriptionListGroup, null,
                                        react.createElement(DescriptionListTerm, null, "Customer name"),
                                        react.createElement(DescriptionListDescription, null,
                                            orderData.customer.name,
                                            " ",
                                            orderData.customer.surname)),
                                    react.createElement(DescriptionListGroup, null,
                                        react.createElement(DescriptionListTerm, null, "Customer Address"),
                                        react.createElement(DescriptionListDescription, null, orderData.customer.address)),
                                    react.createElement(DescriptionListGroup, null,
                                        react.createElement(DescriptionListTerm, null, "Customer City"),
                                        react.createElement(DescriptionListDescription, null, orderData.customer.city)),
                                    react.createElement(DescriptionListGroup, null,
                                        react.createElement(DescriptionListTerm, null, "Customer Zip code"),
                                        react.createElement(DescriptionListDescription, null, orderData.customer.zipCode)))))))),
            react.createElement(GridItem, { span: 10, smRowSpan: 12 }, orderData && (react.createElement(react.Fragment, null,
                react.createElement(Title, { className: "pf-u-mb-sm", headingLevel: "h2" }, "Order details"),
                react.createElement(DataList, { "aria-label": "Simple data list example" }, orderData.items.map(function (data, idx) {
                    return (react.createElement(DataListItem, { key: idx, "aria-labelledby": "item-name-" + idx },
                        react.createElement(DataListItemRow, null,
                            react.createElement(DataListItemCells, { dataListCells: [
                                    react.createElement(DataListCell, { key: "item-name-" + data.id },
                                        react.createElement("span", { id: "item-name-" + data.id },
                                            "Product ",
                                            data.product.name)),
                                    react.createElement(DataListCell, { key: "item-id-" + data.id },
                                        "ID ",
                                        data.product.id),
                                    react.createElement(DataListCell, { key: "item-description-" + orderData.id },
                                        "Description: ",
                                        data.product.description),
                                    react.createElement(DataListCell, { key: "item-price-" + orderData.id },
                                        "Price ",
                                        data.price),
                                    react.createElement(DataListCell, { key: "item-quantity-" + orderData.id },
                                        "Quantity ",
                                        data.quantity),
                                ] }))));
                }))))))))));
...
;// CONCATENATED MODULE: ./src/app/Products/Products.tsx




var Products = function () {
    var _a = react.useState(), productsData = _a[0], setProductsData = _a[1];
    var _b = react.useState(0), curPage = _b[0], setCurPage = _b[1];
    var history = (0,react_router/* useHistory */.k6)();
    var getProducts = function () { return fetch("/products-api/products?page=" + curPage); };
    react.useEffect(function () {
        getProducts()
            .then(function (result) { return result.json(); })
            .then(function (data) { return setProductsData(data); });
    }, [curPage]);
    return (react.createElement(PageSection, null,
        productsData && (react.createElement(TextContent, null,
            react.createElement(Title, { headingLevel: "h1", className: "pf-u-mb-sm" },
                "Products resource list (Page ",
                curPage + 1,
                " of ",
                productsData.totalPages,
                ")"))),
        productsData && react.createElement(DataList, { "aria-label": "Simple data list example" }, productsData.content.map(function (data, idx) {
            return (react.createElement(DataListItem, { key: idx, "aria-labelledby": "item-name-" + idx },
                react.createElement(DataListItemRow, null,
                    react.createElement(DataListItemCells, { dataListCells: [
                            react.createElement(DataListCell, { key: "item-name-" + data.id },
                                react.createElement("span", { id: "item-name-" + data.id }, data.name)),
                            react.createElement(DataListCell, { key: "item-id-" + data.id }, data.id),
                            react.createElement(DataListCell, { key: "item-description-" + data.id }, data.description)
                        ] }),
                    react.createElement(DataListAction, { "aria-labelledby": "single-action-item1 single-action-action1", id: "single-action-action1", "aria-label": "Actions" },
                        react.createElement(Button, { onClick: function () {
...
;// CONCATENATED MODULE: ./src/app/Products/ProductDetail.tsx


var ProductDetail = function (props) {
    var _a = react.useState(), productData = _a[0], setProductData = _a[1];
    var getProductData = function () { return fetch("/products-api/products/" + props.computedMatch.params.slug); };
    react.useEffect(function () {
        getProductData()
            .then(function (response) { return response.json(); })
    ...
    return (react.createElement(PageSection, null,
        react.createElement(Title, { className: "pf-u-mb-sm", headingLevel: "h1" }, "Details for product resource"),
        productData && (react.createElement(Grid, null,
            react.createElement(GridItem, { rowSpan: 6, smRowSpan: 12 },
                react.createElement(Card, { isFlat: true },
                    react.createElement(Grid, null,
                        react.createElement(GridItem, null,
                            react.createElement(CardBody, null,
                                react.createElement(DescriptionList, null,
                                    react.createElement(DescriptionListGroup, null,
                                        react.createElement(DescriptionListTerm, null, "Name"),
                                        react.createElement(DescriptionListDescription, null, productData.name)),
                                    react.createElement(DescriptionListGroup, null,
                                        react.createElement(DescriptionListTerm, null, "ID"),
                                        react.createElement(DescriptionListDescription, null, productData.id)),
                                    react.createElement(DescriptionListGroup, null,
                                        react.createElement(DescriptionListTerm, null, "Description"),
                                        react.createElement(DescriptionListDescription, null, productData.description))))))))))));
};
...
/* harmony default export */ const exclamation_triangle_icon = ((/* unused pure expression or super */ null && (ExclamationTriangleIcon)));
...
const EmptyStateIcon = (_a) => {
    ...
    const classNames = css(empty_state/* default.emptyStateIcon */.Z.emptyStateIcon, className);
...
const EmptyStateBody = (_a) => {
    var { children, className = '' } = _a, props = __rest(_a, ["children", "className"]);
    return (react.createElement("div", Object.assign({ className: css(empty_state/* default.emptyStateBody */.Z.emptyStateBody, className) }, props), children));
};
...
var NotFound = function () {
    function GoHomeBtn() {
        ...
        return (react.createElement(Button, { onClick: handleClick }, "Take me home"));
    }
    return (react.createElement(PageSection, null,
        react.createElement(EmptyState, { variant: "full" },
            react.createElement(EmptyStateIcon, { icon: ExclamationTriangleIcon }),
            react.createElement(Title, { headingLevel: "h1", size: "lg" }, "404 Page not found"),
            react.createElement(EmptyStateBody, null, "We didn't find a page that matches the address you navigated to."),
            react.createElement(GoHomeBtn, null))));
};
...
var dist = __webpack_require__(2556);
...
var RouteWithTitleUpdates = function (_a) {
    var Component = _a.component, _b = _a.isAsync, isAsync = _b === void 0 ? false : _b, title = _a.title, rest = tslib_es6_rest(_a, ["component", "isAsync", "title"]);
    useA11yRouteChange(isAsync);
    useDocumentTitle(title);
    function routeWithTitle(routeProps) {
        return react.createElement(Component, tslib_es6_assign({}, rest, routeProps));
    }
    return react.createElement(react_router/* Route */.AW, tslib_es6_assign({ render: routeWithTitle }, rest));
};
var PageNotFound = function (_a) {
    var title = _a.title;
    useDocumentTitle(title);
    return react.createElement(react_router/* Route */.AW, { component: NotFound });
};
var flattenedRoutes = routes.reduce(function (flattened, route) { return __spreadArray(__spreadArray([], flattened), (route.routes ? route.routes : [route])); }, []);
var AppRoutes = function () { return (react.createElement(dist.LastLocationProvider, null,
    react.createElement(react_router/* Switch */.rs, null,
        flattenedRoutes.map(function (_a, idx) {
...
;// CONCATENATED MODULE: ./src/app/globex-logo.png
/* harmony default export */ const globex_logo = (__webpack_require__.p + "images/globex-logo.png");
...
var AppLayout = function (_a) {
    ...
    var _b = react.useState(true), isNavOpen = _b[0], setIsNavOpen = _b[1];
    var _c = react.useState(true), isMobileView = _c[0], setIsMobileView = _c[1];
    var _d = react.useState(false), isNavOpenMobile = _d[0], setIsNavOpenMobile = _d[1];
    var history = (0,react_router/* useHistory */.k6)();
    var onNavToggleMobile = function () {
        setIsNavOpenMobile(!isNavOpenMobile);
    };
    var onNavToggle = function () {
        setIsNavOpen(!isNavOpen);
    };
    var onPageResize = function (props) {
        setIsMobileView(props.mobileView);
    };
    var Header = (react.createElement(PageHeader, { logoComponent: Button, logo: react.createElement("img", { style: { maxHeight: '40px', paddingTop: '6px' }, src: globex_logo, alt: "Globex logo" }), logoProps: {
            onClick: function () { return history.push('/'); },
            variant: 'link',
            isInline: true,
            className: 'logoLink'
        }, showNavToggle: true, isNavOpen: isNavOpen, onNavToggle: isMobileView ? onNavToggleMobile : onNavToggle }));
    var location = (0,react_router/* useLocation */.TH)();
    var renderNavItem = function (route, index) { return (react.createElement(NavItem, { key: route.label + "-" + index, id: route.label + "-" + index },
        react.createElement(react_router_dom.NavLink, { exact: route.exact, to: route.path, activeClassName: "pf-m-current" }, route.label))); };
    var renderNavGroup = function (group, groupIndex) { return (react.createElement(NavExpandable, { key: group.label + "-" + groupIndex, id: group.label + "-" + groupIndex, title: group.label, isActive: group.routes.some(function (route) { return route.path === location.pathname; }) }, group.routes.map(function (route, idx) { return route.label && renderNavItem(route, idx); }))); };
    var Navigation = (react.createElement(Nav, { id: "nav-primary-simple", theme: "dark" },
        react.createElement(NavList, { id: "nav-list-simple" }, routes.map(function (route, idx) { return route.label && (!route.routes ? renderNavItem(route, idx) : renderNavGroup(route, idx)); }))));
    var Sidebar = (react.createElement(PageSidebar, { theme: "dark", nav: Navigation, isNavOpen: isMobileView ? isNavOpenMobile : isNavOpen }));
    var pageId = 'primary-app-container';
    var PageSkipToContent = (react.createElement(SkipToContent, { onClick: function (event) {
            event.preventDefault();
            var primaryContentContainer = document.getElementById(pageId);
            primaryContentContainer && primaryContentContainer.focus();
        }, href: "#" + pageId }, "Skip to Content"));
    return (react.createElement(Page, { mainContainerId: pageId, header: Header, sidebar: Sidebar, onPageResize: onPageResize, skipToContent: PageSkipToContent }, children));
};
...
var App = function () { return (react.createElement(react_router_dom.BrowserRouter, null,
